...
public class ProductPanel1InBook_송도현 extends JPanel {
	...
	public ProductPanel1InBook_송도현(JTabbedPane shopTabbedPane) {
	...
	public ProductPanel1InBook_송도현() {
		...
		productImage1Btn.setIcon(new ImageIcon(ProductPanel1InBook_송도현.class.getResource("/product_Image/국내도서1.png")));
		...
		productSumDesc1Text.setText("상품번호: 1\r\n상품명: 만일 내가 인생을 다시 산다면\r\n가격: 10,000원");
		productSumDesc1Text.setBounds(164, 47, 159, 75);
		...
		product1CartAddBtn.setIcon(new ImageIcon(ProductPanel1InBook_송도현.class.getResource("/image/smallcart.png")));
		...
		productImage2Btn.setIcon(new ImageIcon(ProductPanel1InBook_송도현.class.getResource("/product_Image/국내도서2.png")));
		productImage2Btn.setBounds(0, 0, 152, 176);
		productPanel2.add(productImage2Btn);
		
		productSumDesc2Text = new JTextPane();
		productSumDesc2Text.setText("상품번호: 2\r\n상품명: 불편한 편의점\r\n가격: 15,000원");
		...
		product2CartAddBtn.setIcon(new ImageIcon(ProductPanel1InBook_송도현.class.getResource("/image/smallcart.png")));
		...
		productImage3Btn.setIcon(new ImageIcon(ProductPanel1InBook_송도현.class.getResource("/product_Image/국내도서3.png")));
		...
		productSumDesc3Text.setText("상품번호: 3\r\n상품명: 하얼빈\r\n가격: 18,000원");
		...
		product3CartAddBtn.setIcon(new ImageIcon(ProductPanel1InBook_송도현.class.getResource("/image/smallcart.png")));
